...
class End2End:
    ...
    def _train_model(self, device, model, train_loader, criterion_seg, criterion_dec, optimizer, validation_set, tensorboard_writer):
        ...
        for epoch in range(num_epochs):
            ...
            for iter_index, (data) in tqdm(enumerate(train_loader)):
               ...
               # print(data.size)
                ...
                if iter_index %100 ==  0:
                    print("curr_loss_seg:", round(curr_loss_seg, 2), "curr_loss_dec:", round(curr_loss_dec, 2), "curr_loss:", round(curr_loss, 2), "correct:", round(correct, 2))
            end = timer()
    ...
    def eval_model(self, device, model, eval_loader, save_folder, save_images, is_validation, plot_seg):
        ...
        for data_point in eval_loader:
            ...
            pred_seg = pred_seg.detach().cpu().numpy() #class activation map
